                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu">
                        ...
                        <li class="has-submenu">
                            <a href="/customers"> <i class="mdi mdi-view-dashboard"></i>List Customer</a>
                        </li>
                                ...
                                <div class="col-lg-6">
                                    <c:if test="${requestScope.message != null}">
                                        <div class="alert alert-icon alert-success alert-dismissible fade show" role="alert">
                                            ...
                                            <strong>Well done!</strong> Successfully create customer.
                                        </div>
                                    </c:if>
                                    <c:if test="${requestScope.errors!=null && requestScope.errors.size()!=0}">
                                        <div class="alert alert-icon alert-danger alert-dismissible fade show mb-0" role="alert">
                                            <c:forEach var="error" items="${requestScope.errors}">
                                                ...
                                                <i class="mdi mdi-block-helper mr-2">${error}</i>
                                            </c:forEach>
                                        </div>
                                    </c:if>
                                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name ="name" class="form-control" value="${requestScope.customer.getName()}" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-2 control-label" for="example-email">Date of Birth</label>
                                            <div class="col-md-10">
                                                <input type="date" id="example-email" name="createdAt" class="form-control" value="<fmt:formatDate pattern = "yyyy-MM-dd"
                                            value = "${requestScope.customer.getCreateAt()}" />" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-2 control-label">Address</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" name="address" value="${requestScope.customer.getAddress()}" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
