                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu">
                        ...
                        <li class="has-submenu active">
                            ...
                            <ul class="submenu in">
                                <li class="has-submenu active">
                                    <a href="#" class="active">Forms <div class="arrow-down"></div></a>
                                    <ul class="submenu in">
                                        <li class="active"><a href="form-elements.html" class="active">Form Elements</a></li>
                                ...
                                <div class="col-lg-6">
                                    <c:if test="${requestScope.message != null}">
                                        <div class="alert alert-icon alert-success alert-dismissible fade show" role="alert">
                                            ...
                                            <strong>Well done!</strong> Successfully edit customer.
                                        </div>
                                    </c:if>
                                    ...
                                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name ="name" class="form-control" value="${requestScope.customer.getName()}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            value = "${requestScope.customer.getCreateAt()}" />">
                                            </div>
                                        </div>
                                        <div class="form-group row">
