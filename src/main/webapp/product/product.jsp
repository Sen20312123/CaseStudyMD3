                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive ">
                            <div><h1 class="header-title">List of Product</h1>
                                    ...
                                    <div class="col-sm-12">
                                        <table class="table table-striped m-0">
                                            ...
                                            <tr role="row">
                                                ...
                                                <th  tabindex="0" aria-controls="datatable"
                                                     rowspan="1" colspan="1" style="width: 181px;" >Name Product
                                                </th>
                                                ...
                                                <th  tabindex="0" aria-controls="datatable" rowspan="1"
                                                     ...
                                                     aria-label="Office: activate to sort column ascending">Price
                                                </th>
                                                <th  tabindex="0" aria-controls="datatable" rowspan="1"
                                                ...
                                                <th  tabindex="0" aria-controls="datatable" rowspan="1"
                                                     ...
                                                     aria-label="Start date: activate to sort column ascending">Image
                                                </th>
                                                <th tabindex="0" aria-controls="datatable" rowspan="1"
                                            ...
                                            <c:forEach var="p" items="${requestScope.products}">
                                                <tr role="row" class="odd">
                                                    <td tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 10px;">${p.getId()}</td>
                                                    <td tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 181px;">${p.getName()}</td>
                                                    <td tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 181px;">${p.getDescription()}</td>
                                                    <td tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 181px;">${p.getPrice()}</td>
                                                    <td tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 181px;">${p.getQuantity()}</td>
                                                    <td tabindex="0" aria-controls="datatable"
                                                    ...
                                                    <td tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 181px;">
                                                        <c:forEach var="pType" items="${requestScope.categories}">
                                                    ...
                                                    <td tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 181px;">
                                                        <a href="/products?action=edit&id=${p.getId()}"><i
                                                                class=" fas fa-edit"></i></a>
                                                        <a onclick="handleDeleteClick(${p.getId()})"><i
